...
function(add_mqt_qcec_binding target_name)
  # parse the arguments
  ...
  if(ARG_MODULE_NAME)
    ...
    target_compile_definitions(${target_name} PRIVATE MQT_QCEC_MODULE_NAME=${ARG_MODULE_NAME})
  else()
    # use the target name as the module name
    target_compile_definitions(${target_name} PRIVATE MQT_QCEC_MODULE_NAME=${target_name})
  endif()
