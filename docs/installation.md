...
```console
python -c "import mqt.qcec; print(mqt.qcec.__version__)"
```
...
To use the MQT QCEC Python package in your project,
...
- install MQT QCEC on your system
...
because it lets you detect installed versions of MQT QCEC
