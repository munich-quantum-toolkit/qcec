...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/qcec/issues>. Include steps to
...
- 💡 Propose features:
  ...
  <https://github.com/munich-quantum-toolkit/qcec/issues>. Describe the
...
{code}`-DBUILD_MQT_QCEC_TESTS=OFF` to the CMake configure step.
:::
...
MQT QCEC adheres to [Semantic Versioning], with the exception that minor
...
explain how users may need to adapt their usage of MQT QCEC, highlight new
